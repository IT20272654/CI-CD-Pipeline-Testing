...
import { FaBuilding, FaCheckCircle, FaCommentAlt, FaDoorOpen, FaUsers, FaUserShield, FaClock, FaBan, FaDonate } from "react-icons/fa";
...
const DashboardMetrics = () => {
  const [metrics, setMetrics] = useState({
    ...
    totalPendingRequestCount:(null),
    totalRejectedRequestCount:(null),
    totalPaidRequestCount:(null),
  });
  ...
  return (
    ...
    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Total Payment Pending Request */}
        <div className="p-4 bg-white dark:bg-slate-600 dark:text-slate-200 rounded-lg shadow-md flex items-center gap-4">
          <div className="text-yellow-500 text-3xl">
            <FaClock />
          </div>
          <div>
            <h3 className="text-gray-600 dark:text-slate-300 text-sm">Total Payment Pending Request</h3>
            <p className="text-2xl font-bold">{metrics.totalPendingRequestCount !== null ? metrics.totalPendingRequestCount : "Loading..."}</p>
          </div>
        </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-600 dark:text-slate-200 rounded-lg shadow-md flex items-center gap-4">
          ...
          <div>
            <h3 className="text-gray-600 dark:text-slate-300 text-sm">Total Paid Request</h3>
            <p className="text-2xl font-bold">{metrics.totalPaidRequestCount !== null ? metrics.totalPaidRequestCount : "Loading..."}</p>
           </div>
        </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-600 dark:text-slate-200 rounded-lg shadow-md flex items-center gap-4">
          ...
          <div>
            <h3 className="text-gray-600 dark:text-slate-300 text-sm">Total Rejected Request</h3>
            <p className="text-2xl font-bold">{metrics.totalRejectedRequestCount !== null ? metrics.totalRejectedRequestCount : "Loading..."}</p>
           </div>
        </div>
      </div>
    </div>
