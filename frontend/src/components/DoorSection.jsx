...
const DoorSection = ({ doors, setDoors, companyPackage }) => {
  ...
  const isAddButtonDisabled = companyPackage === 'Starter' && filteredDoors.length >= 20;
  ...
  return (
    <div className="p-4 border dark:border-none rounded-lg shadow-sm bg-white dark:bg-slate-600">
      ...
      <button
        className={`px-4 py-2 rounded ${isAddButtonDisabled ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700'}`}
