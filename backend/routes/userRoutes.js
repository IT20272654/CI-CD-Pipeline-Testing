...
router.get('/check-email', authMiddleware, roleMiddleware(['SuperAdmin', 'Admin']), checkEmailUnique);
...
router.get('/check-email-update', authMiddleware, roleMiddleware(['SuperAdmin', 'Admin']), checkEmailUniqueForUpdate);
